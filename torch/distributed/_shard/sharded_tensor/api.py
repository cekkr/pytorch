...
class ShardedTensorBase(torch.TensorBase):
...
class ShardedTensor(ShardedTensorBase):
    ...
    def gather(  # type: ignore[override]
        ...
        gather_list: Optional[List[torch.TensorBase]]
        if rank == dst:
    ...
    def to(self, *args, **kwargs) -> ShardedTensor:
        ...
        if len(args) == 1:
            ...
            elif isinstance(args[0], torch.TensorBase):
    ...
    def local_tensor(self) -> torch.TensorBase:
        """
