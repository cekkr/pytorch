...
def constant_(tensor: TensorBase, val: float) -> TensorBase:
...
def ones_(tensor: TensorBase) -> TensorBase:
...
def zeros_(tensor: TensorBase) -> TensorBase:
...
def xavier_uniform_(
    tensor: TensorBase, gain: float = 1.0, generator: _Optional[torch.Generator] = None
) -> TensorBase:
