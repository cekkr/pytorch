...
def fuse_conv_bn_weights(
    conv_w: torch.TensorBase,
    conv_b: Optional[torch.TensorBase],
    bn_rm: torch.TensorBase,
    bn_rv: torch.TensorBase,
    bn_eps: float,
    bn_w: Optional[torch.TensorBase],
    bn_b: Optional[torch.TensorBase],
...
def fuse_linear_bn_weights(
    linear_w: torch.TensorBase,
    linear_b: Optional[torch.TensorBase],
    bn_rm: torch.TensorBase,
    bn_rv: torch.TensorBase,
    bn_eps: float,
    bn_w: torch.TensorBase,
    bn_b: torch.TensorBase,
) -> Tuple[torch.nn.Parameter, torch.nn.Parameter]:
