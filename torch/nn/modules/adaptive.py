...
class AdaptiveLogSoftmaxWithLoss(Module):
    ...
    * :attr:`head_bias` if set to True, adds a bias term to the 'head' of the
    ...
    def forward(self, input_: TensorBase, target_: TensorBase) -> _ASMoutput:
    ...
    def log_prob(self, input: TensorBase) -> TensorBase:
    ...
    def predict(self, input: TensorBase) -> TensorBase:
