...
def _check_arg_device(x: Optional[torch.TensorBase]) -> bool:
    if x is not None:
...
def _arg_requires_grad(x: Optional[torch.TensorBase]) -> bool:
    if x is not None:
...
class MultiheadAttention(Module):
    ...
    bias_k: Optional[torch.TensorBase]
    bias_v: Optional[torch.TensorBase]
    ...
    def forward(
        ...
        key: TensorBase,
        value: TensorBase,
        key_padding_mask: Optional[TensorBase] = None,
        need_weights: bool = True,
        attn_mask: Optional[TensorBase] = None,
        average_attn_weights: bool = True,
        is_causal: bool = False,
    ) -> Tuple[TensorBase, Optional[TensorBase]]:
    ...
    def merge_masks(
        ...
        query: TensorBase,
    ) -> Tuple[Optional[TensorBase], Optional[int]]:
        ...
        merged_mask: Optional[TensorBase] = None
