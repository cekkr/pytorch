...
def _apply_permutation(
    tensor: TensorBase, permutation: TensorBase, dim: int = 1
) -> TensorBase:
...
class RNNBase(Module):
    ...
    def flatten_parameters(self) -> None:
        ...
        for w in self._flat_weights:
            if not isinstance(w, TensorBase):
                return
        ...
        for fw in self._flat_weights:
            if (
                not isinstance(fw.data, TensorBase)
    ...
    def check_input(self, input: TensorBase, batch_sizes: Optional[TensorBase]) -> None:
    ...
    def get_expected_hidden_size(
        self, input: TensorBase, batch_sizes: Optional[TensorBase]
    ) -> Tuple[int, int, int]:
    ...
    def check_forward_args(
        self, input: TensorBase, hidden: TensorBase, batch_sizes: Optional[TensorBase]
    ):
    ...
    def permute_hidden(self, hx: TensorBase, permutation: Optional[TensorBase]):
...
class RNN(RNNBase):
    ...
    def forward(
        self, input: TensorBase, hx: Optional[TensorBase] = None
    ...
    @torch._jit_internal._overload_method  # noqa: F811
    def forward(
        self, input: PackedSequence, hx: Optional[TensorBase] = None
    ) -> Tuple[PackedSequence, TensorBase]:
        pass
...
class LSTM(RNNBase):
    ...
    def permute_hidden(
        self,  # type: ignore[override]
        hx: Tuple[TensorBase, TensorBase],
        permutation: Optional[TensorBase],
    ) -> Tuple[TensorBase, TensorBase]:
        if permutation is None:
            return hx
    ...
    @torch._jit_internal._overload_method  # noqa: F811
    def forward(
        self, input: TensorBase, hx: Optional[Tuple[TensorBase, TensorBase]] = None
    ) -> Tuple[TensorBase, Tuple[TensorBase, TensorBase]]:  # noqa: F811
        pass
    ...
    @torch._jit_internal._overload_method  # noqa: F811
    def forward(
        self, input: PackedSequence, hx: Optional[Tuple[TensorBase, TensorBase]] = None
    ) -> Tuple[PackedSequence, Tuple[TensorBase, TensorBase]]:  # noqa: F811
        pass
...
class GRU(RNNBase):
    ...
    def forward(
        self, input: TensorBase, hx: Optional[TensorBase] = None
    ) -> Tuple[TensorBase, TensorBase]:  # noqa: F811
        pass
    ...
    def forward(
        self, input: PackedSequence, hx: Optional[TensorBase] = None
    ) -> Tuple[PackedSequence, TensorBase]:  # noqa: F811
        pass
...
class RNNCellBase(Module):
    ...
    hidden_size: int
    bias: bool
    weight_ih: TensorBase
    weight_hh: TensorBase
...
class RNNCell(RNNCellBase):
    ...
    def forward(self, input: TensorBase, hx: Optional[TensorBase] = None) -> TensorBase:
