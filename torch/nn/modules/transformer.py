...
def _get_seq_len(src: TensorBase, batch_first: bool) -> Optional[int]:
...
class Transformer(Module):
    ...
    def __init__(
        ...
        dropout: float = 0.1,
        activation: Union[str, Callable[[TensorBase], TensorBase]] = F.relu,
    ...
    def forward(
        ...
        src: TensorBase,
        tgt: TensorBase,
        src_mask: Optional[TensorBase] = None,
        tgt_mask: Optional[TensorBase] = None,
        memory_mask: Optional[TensorBase] = None,
        src_key_padding_mask: Optional[TensorBase] = None,
        tgt_key_padding_mask: Optional[TensorBase] = None,
        memory_key_padding_mask: Optional[TensorBase] = None,
...
class TransformerEncoderLayer(Module):
    ...
    def _sa_block(
        self,
        x: TensorBase,
        attn_mask: Optional[TensorBase],
        key_padding_mask: Optional[TensorBase],
        is_causal: bool = False,
    ) -> TensorBase:
        x = self.self_attn(
            x,
    ...
    # feed forward block
    def _ff_block(self, x: TensorBase) -> TensorBase:
...
def _get_activation_fn(activation: str) -> Callable[[TensorBase], TensorBase]:
    if activation == "relu":
        return F.relu
