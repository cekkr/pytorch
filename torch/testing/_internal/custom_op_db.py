...
def numpy_cube(x: TensorBase) -> Tuple[TensorBase, TensorBase]:
...
def numpy_mul(x: TensorBase, y: TensorBase) -> TensorBase:
    raise NotImplementedError()
...
def numpy_sort(x: TensorBase, dim: int) -> Tuple[TensorBase, TensorBase, TensorBase]:
    raise NotImplementedError()
...
def numpy_take(
    x: TensorBase, ind: TensorBase, ind_inv: TensorBase, dim: int
) -> TensorBase:
    raise NotImplementedError()
...
def numpy_nonzero(x: TensorBase) -> TensorBase:
    raise NotImplementedError()
...
def numpy_view_copy(x: TensorBase, shape: Sequence[int]) -> TensorBase:
    raise NotImplementedError()


@custom_ops.impl("_torch_testing::numpy_view_copy")
def numpy_view_copy_impl(x, shape) -> TensorBase:
...
def numpy_cat(xs: Sequence[TensorBase], dim: int) -> TensorBase:
    raise NotImplementedError()
...
def numpy_split_copy(
    x: TensorBase, sections: Sequence[int], dim: int
) -> List[TensorBase]:
    raise NotImplementedError()
...
def numpy_nms(
    boxes: TensorBase, scores: TensorBase, iou_threshold: Number
) -> TensorBase:
    raise NotImplementedError()
