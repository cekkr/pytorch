...
class LoggingTensor(torch.TensorBase):
    ...
    def __torch_dispatch__(cls, func, types, args=(), kwargs=None):
        ...
        def wrap(e):
            return cls(e) if isinstance(e, torch.TensorBase) else e
...
class LoggingTensorHandler(logging.Handler):
    ...
    def _shortid(self, t: torch.TensorBase) -> int:
    ...
    def _fmt(self, a: object, with_type: bool = False) -> str:
        cond_cls = (
            torch.TensorBase if self.use_shortid_for_all_tensors else LoggingTensor
        )
