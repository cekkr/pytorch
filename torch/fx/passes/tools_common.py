...
Tensors = Union[Tuple[torch.TensorBase], List[torch.TensorBase]]
TensorOrTensors = Union[torch.TensorBase, Tensors]
...
def is_node_output_tensor(node: torch.fx.Node) -> bool:
    ...
    return type_ is not None and issubclass(type_, torch.TensorBase)
