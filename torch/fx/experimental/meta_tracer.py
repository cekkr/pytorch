...
class MetaTracer(torch.fx.Tracer):
        ...
        try:
            ...
            if kind == "call_function":
                ...
                try:
                    ...
                    assert isinstance(attr_itr, torch.TensorBase)
    ...
    def trace(self, root, meta_args: Dict[str, torch.TensorBase], concrete_args=None):
...
def symbolic_trace(
    ...
    meta_args: Optional[Dict[str, torch.TensorBase]] = None,
