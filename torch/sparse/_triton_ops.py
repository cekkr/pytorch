...
def bsr_dense_addmm(
    ...
    bsr: torch.TensorBase,
    dense: torch.TensorBase,
    *,
    beta=1,
    alpha=1,
    out: Optional[torch.TensorBase] = None,
...
if has_triton():
    ...
    def _scaled_dot_product_attention(
        ...
        attn_mask: Optional[torch.TensorBase],
        dropout_p: float = 0.0,
    ...
    def _scatter_mm2(
        blocks: torch.TensorBase,
        others: torch.TensorBase,
        pq_offsets: torch.TensorBase,
        pq_indices: torch.TensorBase,
        accumulators: torch.TensorBase,
    ):
        P, M, K = blocks.shape
        Q, _, N = others.shape
    ...
    def _scatter_mm6(
        blocks: torch.TensorBase,
        others: torch.TensorBase,
        c_indices: torch.TensorBase,
        r_offsets: torch.TensorBase,
        p_offsets: torch.TensorBase,
        q_offsets: torch.TensorBase,
        meta: dict,
        accumulators: torch.TensorBase,
