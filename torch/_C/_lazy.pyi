...
def _get_graph_hash(tensors: List[TensorBase]) -> str: ...
def _sync_multi(
...
def _get_tensor_id(tensor: TensorBase) -> int: ...
def _get_tensors_text(tensors: List[TensorBase]) -> str: ...
def _get_tensors_dot(tensors: List[TensorBase]) -> str: ...
def _get_tensors_backend(tensors: List[TensorBase]) -> str: ...
