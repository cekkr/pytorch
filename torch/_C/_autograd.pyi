...
def _record_function_with_args_enter(name: str, *args) -> torch.TensorBase: ...
def _record_function_with_args_exit(handle: torch.TensorBase) -> None: ...
...
def _unsafe_set_version_counter(t: torch.TensorBase, prev_version: int) -> None: ...
...
def _set_creation_meta(t: torch.TensorBase, creation_meta: CreationMeta) -> None: ...
def _get_creation_meta(t: torch.TensorBase) -> CreationMeta: ...
