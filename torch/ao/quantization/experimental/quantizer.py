...
class APoTQuantizer:
    ...
    def quantize(self, tensor2quantize: TensorBase):
        result = torch.tensor([])
    ...
    def dequantize(self, apot_tensor) -> TensorBase:
    ...
    def quant_dequant(self, tensor2quantize: TensorBase) -> TensorBase:
...
def dequantize_APoT(apot_tensor) -> TensorBase:
