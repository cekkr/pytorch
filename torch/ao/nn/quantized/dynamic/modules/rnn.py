...
from torch import TensorBase  # noqa: F401
...
class RNNBase(torch.nn.Module):
    ...
    def permute_hidden(
        self, hx: TensorBase, permutation: Optional[TensorBase]
    ) -> TensorBase:
...
class LSTM(RNNBase):
    ...
    def forward_impl(
        self,
        input: TensorBase,
        hx: Optional[Tuple[TensorBase, TensorBase]],
    ...
    ) -> Tuple[PackedSequence, Tuple[TensorBase, TensorBase]]:
    ...
    def permute_hidden(  # type: ignore[override]
        self, hx: Tuple[TensorBase, TensorBase], permutation: Optional[TensorBase]
...
class RNNCellBase(torch.nn.Module):
    ...
    def check_forward_hidden(
        self, input: TensorBase, hx: TensorBase, hidden_label: str = ""
    ) -> None:
