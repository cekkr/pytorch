...
) -> Dict[str, Dict[str, torch.TensorBase]]:
...
class Shadow(nn.Module):
    ...
    def add(self, x: torch.TensorBase, y: torch.TensorBase) -> torch.TensorBase:
        """ """  # blank docblock to make autodoc happy
    ...
    def add_scalar(self, x: torch.TensorBase, y: float) -> torch.TensorBase:
        """ """  # blank docblock to make autodoc happy
    ...
    def mul(self, x: torch.TensorBase, y: torch.TensorBase) -> torch.TensorBase:
        """ """  # blank docblock to make autodoc happy
    ...
    def mul_scalar(self, x: torch.TensorBase, y: float) -> torch.TensorBase:
        """ """  # blank docblock to make autodoc happy
    ...
    def cat(self, x: List[torch.TensorBase], dim: int = 0) -> torch.TensorBase:
        """ """  # blank docblock to make autodoc happy
    ...
    def add_relu(self, x: torch.TensorBase, y: torch.TensorBase) -> torch.TensorBase:
        """ """  # blank docblock to make autodoc happy
