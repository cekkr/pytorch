...
from ._utils import _functionalize_sync as _sync, _import_dotted_name, classproperty
...
def sym_not(a):
    ...
    from .overrides import handle_torch_function, has_torch_function_unary
...
def is_tensor(obj):
    ...
    """
    return isinstance(obj, torch.TensorBase)
...
from ._tensor import TensorBase
from .storage import (
    _LegacyStorage,
    _StorageBase,
...
def _assert(condition, message):
    ...
    if type(condition) is not torch.TensorBase and has_torch_function((condition,)):
...
from torch import quantization as quantization, quasirandom as quasirandom
...
from ._linalg_utils import (  # type: ignore[misc]  # type: ignore[misc]
    _symeig as symeig,
    eig,
    lstsq,
    matrix_rank,
...
# expose return_types
from . import library, return_types
