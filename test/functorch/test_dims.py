...
class TestMin(TestCase):
    ...
    def setUp(self):
        ...
        for o in gc.get_objects():
            if isinstance(o, (torch.TensorBase, Dim, Tensor, DimList)):
    ...
    def tearDown(self):
        ...
        for o in gc.get_objects():
            if (
                isinstance(o, (torch.TensorBase, Dim, Tensor, DimList))
    ...
    def test_doc(self):
        assert Tensor.clamp.__doc__ == torch.TensorBase.clamp.__doc__
