...
class TestComplex(JitTestCase):
    ...
    def test_complex_parse(self):
        def fn(a: int, b: torch.TensorBase, dim: int):
    ...
    def test_binary_op_complex_tensor(self):
        def mul(x: complex, y: torch.TensorBase):
            return x * y

        def add(x: complex, y: torch.TensorBase):
            return x + y

        def eq(x: complex, y: torch.TensorBase):
            return x == y

        def ne(x: complex, y: torch.TensorBase):
            return x != y

        def sub(x: complex, y: torch.TensorBase):
            return x - y

        def div(x: complex, y: torch.TensorBase):
            return x - y
