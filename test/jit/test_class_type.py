...
class TestClassType(JitTestCase):
    ...
    def test_class_type_as_param(self):
        ...
        @torch.jit.script
        def fn(foo: FooTest) -> torch.TensorBase:
            return foo.attr
    ...
    def test_class_specialization(self):
        ...
        def use_foo(foo: Foo, foo2: Foo, tup: Tuple[Foo, Foo]) -> torch.TensorBase:
            a, b = tup
    ...
    def test_interface(self):
        ...
        @torch.jit.interface
        class OneTwo:
            def one(self, x: torch.TensorBase, y: torch.TensorBase) -> torch.TensorBase:
                pass

            def two(self, x: torch.TensorBase) -> torch.TensorBase:
                pass
        ...
        class OneTwoThree:
            ...
            def three(self, x: torch.TensorBase) -> torch.TensorBase:
                pass
    ...
    def test_overloaded_fn(self):
        ...
        class Foo:
            ...
            def __mul__(self, other: torch.TensorBase) -> torch.TensorBase:
                return self.x * other
    ...
    def test_custom_delete(self):
        ...
        class Example:
            def __init__(self):
                self._data: Dict[str, torch.TensorBase] = {"1": torch.tensor(1.0)}
