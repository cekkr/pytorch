...
class TestAutodiffSubgraphSlicing(JitTestCase):
    ...
    def test_bias_as_arg(self):
        ...
        with enable_profiling_mode_for_profiling_tests():
            ...
            def method1(x, weight, bias: Optional[torch.TensorBase]):
    ...
    def test_requires_grad_for_tensor_list(self):
        ...
        with enable_profiling_mode_for_profiling_tests():
            ...
            def func(
                input0: torch.TensorBase, input1: torch.TensorBase
            ) -> Tuple[torch.TensorBase, List[torch.TensorBase]]:
    ...
    def test_differentiable_graph_ops_requires_grad(self):
        ...
        def t(x: torch.TensorBase, y: torch.TensorBase, flag: bool):
            o = x + 1.0
            o1 = torch.relu(o)
            o = y + 1.5
            o2 = torch.relu(o)
