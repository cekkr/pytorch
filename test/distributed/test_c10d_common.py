...
class CommonDistributedDataParallelTest:
    ...
    @dataclass
    class CustomOutput:
        o1: Optional[torch.TensorBase]
        o2: Dict[str, torch.TensorBase]
...
class CompilerTest(MultiProcessTestCase):
    ...
    def _test_work_wait(self, x: torch.TensorBase, comm_fn: Callable):
        ...
        def fn(x: torch.TensorBase) -> torch.TensorBase:
            ...
            elif isinstance(z, torch.TensorBase):
                return z * 2
            else:
