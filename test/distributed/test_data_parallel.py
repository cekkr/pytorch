...
class TestDataParallel(TestCase):
    ...
    def test_data_parallel_nested_output(self):
        ...
        self.assertIsInstance(output[0], torch.TensorBase)
        self.assertIsInstance(output[1], tuple)
        self.assertIsInstance(output[1][0], torch.TensorBase)
        self.assertIsInstance(output[1][1], torch.TensorBase)
        self.assertIsInstance(output[1][2], list)
        self.assertIsInstance(output[1][2][0], torch.TensorBase)
        self.assertIsInstance(output[2], torch.TensorBase)
        self.assertIsInstance(output[3], dict)
        self.assertEqual(len(output[3]), 2)
        self.assertIn("a", output[3])
        self.assertIn("b", output[3])
        self.assertIsInstance(output[3]["a"], torch.TensorBase)
        self.assertIsInstance(output[3]["b"], list)
        self.assertIsInstance(output[3]["b"][0], torch.TensorBase)
